...
import divas.dazzle.Adapters.ClarityAdapter;
import divas.dazzle.Objects.ClarityObject;
...
public class Clarity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabaseRef =  FirebaseDatabase.getInstance().getReference().child("Users").child(device);
