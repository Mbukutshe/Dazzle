package divas.dazzle.Activities;
...
import divas.dazzle.Fragments.SignUp;
import divas.dazzle.Fragments.Vehicles;
import divas.dazzle.Functions.Animation;
import divas.dazzle.Functions.Functions;
import divas.dazzle.Functions.InsertToDatabase;
import divas.dazzle.Functions.Visible;
import divas.dazzle.Globals.Access;
import divas.dazzle.Globals.Device;
import divas.dazzle.Globals.Globals;
import divas.dazzle.Location.MyLocationListener;
import divas.dazzle.R;
import divas.dazzle.Services.DevicesJSONParser;
import divas.dazzle.Services.Sensor;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        broadCastIntent = new Intent(getApplicationContext(),Sensor.class);
