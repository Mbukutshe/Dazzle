...
import divas.dazzle.Globals.Vehicle;
import divas.dazzle.Holders.TrashAndEditHolder;
...
public class TrashAndEditAdapter extends RecyclerView.Adapter<TrashAndEditHolder>
{
   ...
   android.support.v4.app.FragmentManager fragmentManager;
    ...
    public void onBindViewHolder(TrashAndEditHolder holder, final int position)
    {
        ...
        holder.name.setText(mDataset.get(position).make);
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setIcon(R.drawable.motorlogo);
