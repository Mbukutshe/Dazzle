package divas.dazzle.Fragments;
...
import divas.dazzle.Adapters.VehiclesAdapter;
import divas.dazzle.Globals.Globals;
import divas.dazzle.Objects.VehicleObject;
import divas.dazzle.R;
import divas.dazzle.Services.VehiclesDataset;
...
public class Vehicles extends Fragment implements View.OnClickListener{
    ...
    divas.dazzle.Functions.Animation anim;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       search.setOnClickListener(this);
        anim = new divas.dazzle.Functions.Animation(view.getContext());
        return view;
    }
