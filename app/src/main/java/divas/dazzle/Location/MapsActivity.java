...
import divas.dazzle.Services.Coordinates;
                    ...
                    public void onResponse(String response) {
                        if(!response.equalsIgnoreCase("nodata"))
                        {
                            ...
                            for(int i=0;i<coordinates.size();i++)
                            {
                                ...
                                String name = coordinates.get(i).getTitle()+" "+coordinates.get(i).getInitial()+"."+coordinates.get(i).getSurname();
                                LatLng points = new LatLng(latitude,longitude);
                                options = new MarkerOptions().position(points).title(name+"\n was here.");
