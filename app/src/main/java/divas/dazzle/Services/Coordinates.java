    ...
    public static List<MapCoordinates> parseData(String content) {
        ...
        try {
            ...
            for (int i = 0; i < items_arry.length(); i++) {
                ...
                items = new MapCoordinates(obj.getString("device_lati"),obj.getString("device_longi"),obj.getString("user_title"),obj.getString("user_initial"),obj.getString("user_surname"));
                itemList.add(items);
            }
